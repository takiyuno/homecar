                  ...
                  <tbody>
                    @foreach($data as $row)
                      <tr>
                        ...
                        <td class="text-center">
                          @php
                            $SumAmount = $row->Fisrt_Price+$row->Repair_Price+$row->Color_Price+$row->Add_Price+$row->Budget_Gift+$row->Comsale_turn+$row->com_sale+$row->Insur_Price+$row->Cost_Insur+$row->Tran_Fee;
                          @endphp
