...
<section class="content">
  <div class="content-header">
    <div class="card">
      <form name="form1" action="{{ route('datacarin.store') }}" method="post" id="formimage" enctype="multipart/form-data">
        @csrf
          ...
          <div class="row">
            ...
            <div class="col-8">
              <div class="card-tools d-inline float-right">
                ...
                <a class="delete-modal btn btn-danger btn-sm" href="{{ route('datacarin',1) }}">
              ...
              <div class="card card-warning">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-8">
                          <input type="date" class="form-control form-control-sm" name="Date_Car_in" value="{{ $date }}"  required>
                        </div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="Nameid_Car_in" class="form-control form-control-sm" placeholder="ป้อนเลขทะเบียน" required/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        <label class="col-sm-3 col-form-label text-right"><font color="red">* ประเภทการซื้อเข้า :</font></label>
                        <div class="col-sm-8">
                          <select name="Return_car" id="Return_car" class="form-control form-control-sm">
                            ...
                            <option value="8" >Hi นายหน้า</option>
                            <option value="2" >Hi รถประมูล</option>
                            <option value="7" >รถซื้อหน้าเต้น</option>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-8">
                          <input type="text" id="Miles_Car_in" name="Miles_Car_in" class="form-control form-control-sm" placeholder="ป้อนเลขไมล์" oninput="mile();" maxlength="10"/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="Version_Car_in" class="form-control form-control-sm" placeholder="ป้อนรุ่นรถ" />
                        </div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="Car_Year_in" class="form-control form-control-sm"  placeholder="ป้อนปีที่ผลิต"/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="Size_Car_in" class="form-control form-control-sm" placeholder="ป้อนขนาด C.C." />
                        </div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group row mb-1">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="Color_car_in" class="form-control form-control-sm" placeholder="ป้อนสีรถ" />
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      function mile(){
                        ...
                        <div class="col-6">
                          <div class="form-group row mb-1">
                            ...
                            <div class="col-sm-8">
                              <input type="text" id="Cus_Need_price" name="Cus_Need_price" class="form-control form-control-sm" placeholder="ป้อนราคาลูกค้าต้องการ" oninput="mile();" maxlength="10"/>
                            </div>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="form-group row mb-1">
                            ...
                            <div class="col-sm-8">
                              ...
                              <input type="text" name="Sale_Name"  value="{{auth::user()->username}}" class="form-control form-control-sm" placeholder="ป้อน Sale" />
                              @else
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group row mb-1">
                            <label class="col-sm-3 col-form-label text-right">ลักษณะรถ :</label>
                            <div class="col-sm-8">
                              <textarea name="Detail_Car_in" class="form-control form-control-sm" placeholder="ลักษณะรถ/สภาพ" ></textarea>
                        ...
                        <div class="col-6">
                          <div class="form-group row mb-1">
                            <label class="col-sm-3 col-form-label text-right">สถานไฟแนนซ์ :</label>
                            <div class="col-sm-6">
                              <select id="StatusFN_Car_in" name="StatusFN_Car_in" class="form-control form-control-sm">
                                <option value="ไม่ติดไฟแนนซ์">ไม่ติดไฟแนนซ์</option>
                                <option value="กรุงศรี">กรุงศรี</option>
                                <option value="ธนชาติ">ธนชาติ</option>
                                <option value="ทิสโก้">ทิสโก้</option>
                                <option value="ไทยพาณิชย์">ไทยพาณิชย์</option>
                                <option value="กสิกรลิสซิ่ง">กสิกรลิสซิ่ง</option>
                                <option value="โตโยต้าลิสซิ่ง">โตโยต้าลิสซิ่ง</option>
                                <option value="ฮอนด้าลิสซิ่ง">ฮอนด้าลิสซิ่ง</option>                                
                                <option value="other">อื่นๆ</option>
                              </select>
                                  <!-- <div class="col-md-12">
                                    <span class="todo-wrap">
                                      <input type="radio" id="1" name="StatusFN_Car_in" value="yes"/>
                                      <label for="1" class="todo">
                                        <i class="fa fa-check"></i>
                                        ติดไฟแนนซ์
                                      </label> -->
                                      <div style="display:none;" id="showFinane">
                                        <input type="text" name="name_finance" id="name_finance" class="form-control form-control-sm" placeholder="ระบุชื่อไฟแนนซ์" />
                                      </div>
                                  <!--   </span>
                                   
                                        <span class="todo-wrap">
                                          <input type="radio" id="2" name="StatusFN_Car_in" value="no"/>
                                ...
                                <div class="form-group row mb-1">
                                  ...
                                  <div class="col-sm-8">
                                    <select name="CarType_in" class="form-control form-control-sm">
                                     ...
                                     <option value="3" >นายหน้า/ลูกค้าแนะนำ</option>
                             ...
                             <div class="col-6">
                               <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" name="id_body_car" id="id_body_car" class="form-control form-control-sm" placeholder="เลขตัวถัง" >
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="row">
                              <div class="col-6">
                                <div class="form-group row mb-1">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" name="Name_Cus_Car" value=""  placeholder="ป้อนชื่อหน้าเล่ม">
                                  </div>
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group row mb-1">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" name="Name_Cus_in" class="form-control form-control-sm" placeholder="ป้อนชื่อลูกค้า" />
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-6">
                                <div class="form-group row mb-1">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" name="Nick_Cus_in" value=""  placeholder="ป้อนชื่อเล่น">
                                  </div>
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group row mb-1">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" name="Tel_Cus_in" class="form-control form-control-sm" placeholder="ป้อนเบอร์ติดต่อลูกค้า" />
                                  </div>
                                </div>
                              </div>
                            </div>
